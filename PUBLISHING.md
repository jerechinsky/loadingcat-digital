...
3. Upload `loading-cat-digital.pbw`, version **1.5.8**. It contains aplite, basalt, chalk, diorite, emery, flint and gabbro builds. Keep its existing UUID for subsequent updates.
