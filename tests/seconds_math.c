...
int main(void) {
  ...
  assert(positions_checked == 240000u);
  puts("Seconds timing passed: every millisecond for all four spoke counts, minute wrap, positive boundary delays and 100 minutes without seven-spoke drift.");
  return 0;
}
