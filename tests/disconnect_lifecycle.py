...
static bool s_phone_connected, quiet;
static struct { int disconnect_vibe, disconnect_pattern, disconnect_ignore_quiet; } s_settings;
static int pulses;
...
int main(void) {
  ...
  puts("Disconnect handler passed: all four patterns and Quiet Time override; startup, reconnect, duplicate events, disabled setting, re-enable and Quiet Time.");
}
'''
